...
export function SalesRegisterClient({
  ...
  // Derived metrics from the current filtered set
  const metrics = useMemo(() => {
    ...
    const pendingPaid = initialData.filter(
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <SummaryCard
          ...
          color="emerald"
          description="Gross sales for period"
        />
        <SummaryCard
        ...
        <SummaryCard
          ...
          icon={<Clock size={24} />}
          color="indigo"
          description="GST / Combined tax"
        />
        <SummaryCard
          label="Pending Payments"
          value={metrics.pendingPaid}

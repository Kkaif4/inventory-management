...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var adminEmail, existingAdmin, hashedPassword, existingOutlet;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5: return [4 /*yield*/, prisma.outlet.findFirst()];
                case 6:
                    existingOutlet = _a.sent();
                    if (!!existingOutlet) return [3 /*break*/, 8];
                    return [4 /*yield*/, prisma.outlet.create({
                            data: {
